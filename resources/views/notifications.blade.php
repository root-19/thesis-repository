                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if (isset($notification->data['thesis_id']))
                                        <a href="{{ route('dashboard') }}#thesis-{{ $notification->data['thesis_id'] }}" target="_blank" class="p-2 rounded-lg bg-[#FFFCF2] text-[#403D39] hover:bg-[#EB5E28] hover:text-white transition-colors">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
