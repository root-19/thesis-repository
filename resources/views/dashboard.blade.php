            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <p class="text-lg md:text-xl text-[#403D39] leading-relaxed max-w-3xl mx-auto mb-8">
                        Access thesis papers, capstone projects, and scholarly documents uploaded by administrators. Search by title, author, department, or keyword to find the research you need.
                    </p>
                    ...
                    <div class="thesis-feed-item bg-white rounded-2xl shadow-sm border border-[#CCC5B9]/20 overflow-hidden"
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                @if ($thesis->coAuthors->count() > 0)
                                    @php $firstAuthor = $thesis->coAuthors->first(); @endphp
                                    <a href="{{ route('user.messages.show', $firstAuthor) }}" class="flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-[#FFFCF2] text-[#403D39] hover:bg-[#EB5E28] hover:text-white transition-colors">
                                        @if ($firstAuthor->profile_image_path)
